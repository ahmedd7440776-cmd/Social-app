    ...
    return (
        <Card className="max-w-4xl w-full  border-red-500 border-2 ">
            <Card.Header>
             ...
             <button onClick={() => { setIsEditMode(true); setShowMenu(false) }} className='flex items-center gap-2 px-3 py-2w-full hover:bg-gray-100'>
                 <Edit2 size='18' />Edit
             </button>
            ...
            <Card.Footer className='flex-col py-3 mt-3 border-t border-gray-400'>
                <div className='flex justify-between w-full'>
                    ...
                    <div className='flex items-center gap-3'>
                        {!PostsDetails && <Link className='gap-3 flex items-center ' to={`/postDetails/${postId}`}>
                            {commentsCount}
